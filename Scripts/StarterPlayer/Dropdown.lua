--[[
  ...
  Method:   decompile
  Name:     Dropdown
  Path:     game.StarterPlayer.StarterPlayerScripts.Satchel.Satchel.Packages._Index.legitatx_topbarplus@3.0.5.topbarplus.Elements.Dropdown
    ...
    local function updateMaxIcons() -- Line: 107
        ...
        for _, child in pairs(ScrollingFrame:GetChildren()) do
            if child:IsA("GuiObject") then
                table.insert(v8, { child, child.AbsolutePosition.Y });
            end;
        end;

        table.sort(v8, function(p9, p10) -- Line: 133
            return p9[2] < p10[2];
        end);
        local v11 = 0;
        local v12 = false;
        ...
        for i = 1, Attribute do
            ...
            local v14 = v13[1];
            v11 = v11 + v14.AbsoluteSize.Y;
            local Attribute2 = v14:GetAttribute("WidgetUID");
            ...
            if Attribute2 then
                ...
                if v12 then
                    ...
                    v16 = u1:getInstance("ClickRegion");
                    v12 = true;
                end;

                Attribute2:getInstance("ClickRegion").NextSelectionUp = v16;
                v15 = i;
            else
                v15 = i;
            end;
        ...
        ScrollingFrame.Size = UDim2.fromOffset(0, v11 + UIPadding.PaddingTop.Offset + UIPadding.PaddingBottom.Offset);
    end;
