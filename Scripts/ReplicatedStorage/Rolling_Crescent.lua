--[[
  ...
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Shadow Vagrant.Rolling_Crescent
...
function u1.Activate(u6, u7) -- Line: 62
    ...
    if not v9 then
        warn("[Boss Rolling_Crescent] Animation not found:", v8);
    ...
    local v13 = v9:GetMarkerReachedSignal("VFX"):Connect(function(p11) -- Line: 83
    ...
    local v15 = v9:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 92
    ...
    v9.Stopped:Once(function() -- Line: 101
        -- upvalues: u10 (ref)
        u10 = true;
    end);
    task.delay(u7.MaxDuration or u1.MaxDuration, function() -- Line: 102
        -- upvalues: u10 (ref)
        u10 = true;
    end);
