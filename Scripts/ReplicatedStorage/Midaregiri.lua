--[[
  ...
  Method:   decompile
  Name:     Midaregiri
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Master Ronin.Midaregiri
...
local u1 = {
    ...
    MaxDuration = 5,
    OpeningHitboxSize = Vector3.new(18, 12, 24),
    OpeningHitboxRange = 24,
    RapidfireHitboxSize = Vector3.new(16, 12, 22),
    RapidfireHitboxRange = 22,
    RandomSlashPool = { "Right_Slash", "Left_Slash", "Center_Slash", "Reverse_Slash", "Reverse_Right_Slash" }
};
...
local function RandomOffset(p3) -- Line: 62
...
function u1._SpawnClones(u6, p7) -- Line: 71
    -- upvalues: u2 (copy)
    if not u2 then
        return;
    end;
...
function u1._PerformHit(p18, p19, p20, p21) -- Line: 100
...
function u1.Activate(u24, u25) -- Line: 112
    -- upvalues: u1 (copy), Debris (copy)
    local v26 = u24.Animations[u1.AnimationName];

    if not v26 then
        warn("[Boss Midaregiri] Animation not found:", u1.AnimationName);
    ...
    local u28 = u25.OpeningDamageMult or (u25.FinalDamageMult or 3);
    local u29 = u25.DamageMultiplier or 1.2;
    ...
    local u34 = 0;
    local v38 = v26:GetMarkerReachedSignal("hit"):Connect(function(p35) -- Line: 147
        -- upvalues: u34 (ref), u25 (copy), u24 (copy), u1 (ref), u28 (copy), u30 (copy), u31 (copy), u29 (copy), u32 (copy), u33 (copy)
        u34 = u34 + 1;
        u24:PlayCombatSound(u25.SwingSoundFolder or (u24.ClassData.SwingSoundFolder or "Magic_Swings"), nil, u24.ClassData.SwingVolume or 1);
    ...
    local v41 = v26:GetMarkerReachedSignal("DBreset"):Connect(function() -- Line: 183
        ...
        BodyVelocity.Name = "BossMidaregiri_BackDash";
        BodyVelocity.MaxForce = Vector3.new(100000, 0, 100000);
        BodyVelocity.Velocity = Unit * (u25.DashSpeed or 55);
        BodyVelocity.Parent = v39;
        Debris:AddItem(BodyVelocity, u25.DashDuration or 0.2);
    end);
    v26.Stopped:Once(function() -- Line: 200
        -- upvalues: u27 (ref)
        u27 = true;
    end);
