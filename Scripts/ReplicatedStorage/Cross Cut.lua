--[[
  ...
  Method:   decompile
  Name:     Cross Cut
  Path:     game.ReplicatedStorage.Classes.Azure Devil.Skills.Cross Cut
...
function u2._EnsureAnimation(p3) -- Line: 59
...
function u2._PerformHit(p8) -- Line: 86
    -- upvalues: u2 (copy)
...
function u2._Dash(p11, p12) -- Line: 112
...
function u2._AirDash(p14, u15, p16) -- Line: 142
    -- upvalues: u2 (copy)
    ...
    task.delay(u2.DashDuration, function() -- Line: 153
        -- upvalues: u15 (copy)
...
function u2._SpawnClones(u18) -- Line: 161
...
function u2.CanActivate(p20) -- Line: 183
...
function u2.Activate(u21, p22) -- Line: 191
    -- upvalues: u2 (copy), SharedUtils (copy)
    local v23 = u2._EnsureAnimation(u21);

    if not v23 then
        warn("[Cross Cut] Animation not found");
    ...
    task.delay(u2.IFrameDuration, function() -- Line: 216
        -- upvalues: u21 (copy)
    ...
    local function disconnectAll() -- Line: 244
        -- upvalues: u26 (copy)
        for _, v in u26 do
            v:Disconnect();
        end;
    ...
    local function releaseState() -- Line: 254
    ...
    u26[#u26 + 1] = v23:GetMarkerReachedSignal("dash"):Connect(function(p28) -- Line: 273
    ...
    u26[#u26 + 1] = v23:GetMarkerReachedSignal("hit"):Connect(function(p29) -- Line: 285
        -- upvalues: u21 (copy), u2 (ref)
        u21:PlayCombatSound(u21.ClassData.SwingSoundFolder or "Sword_Swings", nil, u21.ClassData.SwingVolume or 0.5);
    ...
    task.delay(u2.MaxDuration, function() -- Line: 313
        -- upvalues: u27 (ref), u25 (ref), u21 (copy), u26 (copy)
        if not u27 then
            u27 = true;
