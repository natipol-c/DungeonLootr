--[[
  ...
  Method:   decompile
  Name:     Tempest Edge
  Path:     game.ReplicatedStorage.Classes.Jetstream.Skills.Tempest Edge
...
function u1.Activate(u10, p11) -- Line: 110
    ...
    if not v12 then
        warn("[Tempest Edge] Animation not found");
    ...
    u14[#u14 + 1] = v12:GetMarkerReachedSignal("VFX"):Connect(function(p16) -- Line: 160
        ...
        if p16 == u1.FinisherParam then
            SharedUtils.PlaySoundAt(v17, u1.SheatheSFX, 0.85);
            u10:ShakeCamera("SkillHeavy");
        end;

        u10:PlayEffectModule(u1.EffectModule, "Emit", v17.CFrame, p16);
    end);
    u14[#u14 + 1] = v12:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 174
