--[[
  ...
  Method:   decompile
  Name:     Gazelle Sweep
  Path:     game.ReplicatedStorage.Classes.Boxer.Skills.Gazelle Sweep
...
function u1._PerformHit(p7) -- Line: 77
    -- upvalues: u1 (copy)
...
function u1._Dash(p10) -- Line: 102
...
function u1.CanActivate(p12) -- Line: 126
...
function u1.Activate(u13, p14) -- Line: 134
    -- upvalues: u1 (copy), SharedUtils (copy)
    local v15 = u1._EnsureAnimation(u13);

    if not v15 then
        warn("[Gazelle Sweep] Animation not found");
    ...
    task.delay(u1.IFrameDuration, function() -- Line: 159
        -- upvalues: u13 (copy)
    ...
    SharedUtils.PlaySoundAt(Character, "Fire_Woosh", u1.WooshVolume);
    v15:Play(0, 1, 1);
    local u16 = {};
    ...
    u16[#u16 + 1] = v15:GetMarkerReachedSignal("dash"):Connect(function() -- Line: 192
        -- upvalues: u1 (ref), u13 (copy)
        u1._Dash(u13);
        u13:ShakeCamera("SkillLight");
    end);
    u16[#u16 + 1] = v15:GetMarkerReachedSignal("hit"):Connect(function(p18) -- Line: 198
        -- upvalues: u13 (copy), SharedUtils (ref), u1 (ref)
        local v19 = u13.Character and u13.Character:FindFirstChild("HumanoidRootPart");

        if v19 then
            SharedUtils.PlaySoundAt(v19, "explosion_punch", u1.ExplosionVolume);
        end;
    ...
    v15.Stopped:Once(function() -- Line: 214
    ...
    task.delay(u1.MaxDuration, function() -- Line: 221
        -- upvalues: u17 (ref), u13 (copy), u16 (copy)
        if not u17 then
            u17 = true;
            u13.Is_Using_Skill = false;
