--[[
  ...
  Path:     game.ReplicatedStorage.Classes.Jetstream.Skills.Jetstream Sheath
...
function u1.Activate(u10, p11) -- Line: 112
    ...
    if not v12 then
        warn("[Jetstream Sheath] Animation not found");
    ...
    u15[#u15 + 1] = v12:GetMarkerReachedSignal("VFX"):Connect(function(p17) -- Line: 180
    ...
    u15[#u15 + 1] = v12:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 194
