--[[
  ...
  Method:   decompile
  Name:     Devouring_Gale
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Kage.Devouring_Gale
...
function u1.Activate(u6, u7) -- Line: 60
    ...
    if not v8 then
        warn("[Boss Devouring_Gale] Animation not found:", u1.AnimationName);
    ...
    local v11 = v8:GetMarkerReachedSignal("hit"):Connect(function(p10) -- Line: 82
    ...
    v8.Stopped:Once(function() -- Line: 90
        -- upvalues: u9 (ref)
        u9 = true;
    end);
    task.delay(u1.MaxDuration, function() -- Line: 94
        -- upvalues: u9 (ref)
        u9 = true;
    end);
