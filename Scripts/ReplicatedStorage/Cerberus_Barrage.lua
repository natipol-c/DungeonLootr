--[[
  Type:     ModuleScript
  Method:   decompile
  Name:     Cerberus_Barrage
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Founder.Cerberus_Barrage
...
local u1 = {
    ...
    MaxDuration = 4.5,
    HitboxSize = Vector3.new(12, 15, 21),
    HitboxRange = 21
};
...
function u1.Activate(u6, u7) -- Line: 57
    ...
    if not v8 then
        warn("[Boss Cerberus_Barrage] Animation not found:", u1.AnimationName);
    ...
    local v11 = v8:GetMarkerReachedSignal("hit"):Connect(function(p10) -- Line: 79
