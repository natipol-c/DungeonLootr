--[[
  ...
  Method:   decompile
  Name:     Pyre Cyclone
  Path:     game.ReplicatedStorage.Classes.Flame Bastion.Skills.Pyre Cyclone
...
local u1 = {
    ...
    Skill_SFX = nil,
    ParryDuration = 0.6,
    AoEHitboxSize = Vector3.new(20, 10, 20),
    HitboxRange = 14,
    MaxDuration = 2
};
...
function u1.CanActivate(p10) -- Line: 91
...
function u1.Activate(u11, p12) -- Line: 99
    -- upvalues: u1 (copy)
    local v13 = u1._EnsureAnimation(u11);

    if not v13 then
        warn("[Pyre Cyclone] Animation not found");
    ...
    task.delay(u1.ParryDuration, function() -- Line: 123
    ...
    v13:Play(0, 1, 1);
    local u15 = v13:GetMarkerReachedSignal("hit"):Connect(function(p14) -- Line: 134
    ...
    v13.Stopped:Once(function() -- Line: 155
        -- upvalues: u16 (ref), u11 (copy), u15 (ref), u17 (copy), Character (copy)
        if not u16 then
            u16 = true;
            u11.Is_Using_Skill = false;
            u11.Is_Attacking = false;
