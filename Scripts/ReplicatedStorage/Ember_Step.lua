--[[
  ...
  Method:   decompile
  Name:     Ember_Step
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Flame Bastion.Ember_Step
...
local u5 = {
    ...
    _PerformHit = function(p1, p2) -- Line: 43, Name: _PerformHit
...
function u5.Activate(u6, u7) -- Line: 58
    -- upvalues: u5 (copy), Debris (copy)
    local v8 = u6.Animations[u5.AnimationName];

    if not v8 then
        warn("[Boss Ember_Step] Animation not found:", u5.AnimationName);
    ...
    local u10 = 0;
    local v13 = v8:GetMarkerReachedSignal("hit"):Connect(function(p11) -- Line: 81
        -- upvalues: u10 (ref), u6 (copy), u7 (copy), Debris (ref), u5 (ref)
        u10 = u10 + 1;
        ...
        if v12 then
            ...
            BodyVelocity.Velocity = v12.CFrame.LookVector * (u7.DashSpeed or 70);
            BodyVelocity.Parent = v12;
            Debris:AddItem(BodyVelocity, u7.DashDuration or 0.2);
        end;

        u6:PlayCombatSound(u7.SwingSoundFolder or (u6.ClassData.SwingSoundFolder or "Flame_Swing"), nil, u6.ClassData.SwingVolume or 0.5);
    ...
    v8.Stopped:Once(function() -- Line: 109
        -- upvalues: u9 (ref)
        u9 = true;
    end);
    task.delay(u5.MaxDuration, function() -- Line: 114
        -- upvalues: u9 (ref)
        u9 = true;
    end);
