--[[
  ...
  Method:   decompile
  Name:     Rising Flicker
  Path:     game.ReplicatedStorage.Classes.Jetstream.Skills.Rising Flicker
...
local u1 = {
    ...
    Skill_SFX = nil,
    HitboxSize = Vector3.new(25, 10, 25),
    HitboxRange = 25,
    DashSpeed = 150,
    DashDuration = 0.05,
    DodgeDuration = 0.7,
...
function u1.Activate(u10, p11) -- Line: 110
    ...
    if not v12 then
        warn("[Rising Flicker] Animation not found");
    ...
    task.delay(u1.DodgeDuration, function() -- Line: 134
    ...
    local function cleanup() -- Line: 148
    ...
    u14[#u14 + 1] = v12:GetMarkerReachedSignal("Flicker"):Connect(function() -- Line: 160
        -- upvalues: u10 (copy), SharedUtils (ref), u1 (ref), Debris (ref)
        ...
        SharedUtils.PlaySoundAt(v16, u1.FlickerSFX, 0.8);
        local BodyVelocity = Instance.new("BodyVelocity");
        BodyVelocity.Name = "SkillDash";
        BodyVelocity.MaxForce = Vector3.new(100000, 0, 100000);
        BodyVelocity.Velocity = v16.CFrame.LookVector * u1.DashSpeed;
        BodyVelocity.Parent = v16;
        Debris:AddItem(BodyVelocity, u1.DashDuration);
    end);
    u14[#u14 + 1] = v12:GetMarkerReachedSignal("VFX"):Connect(function(p17) -- Line: 175
    ...
    u14[#u14 + 1] = v12:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 183
        -- upvalues: u10 (copy), u1 (ref)
        u10:ShakeCamera("Hit");
