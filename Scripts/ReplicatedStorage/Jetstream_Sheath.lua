--[[
  Type:     ModuleScript
  Method:   decompile
  Name:     Jetstream_Sheath
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Jetstream.Jetstream_Sheath
...
function u1.Activate(u6, u7) -- Line: 59
    ...
    if not v8 then
        warn("[Boss Jetstream_Sheath] Animation not found:", u1.AnimationName);
    ...
    local v13 = {
        [#v13 + 1] = v8:GetMarkerReachedSignal("VFX"):Connect(function(p11) -- Line: 88
            ...
            for _, v in u1.ImpactSFX do
                SharedUtils.PlaySoundAt(v12, v, 0.85);
            end;

            u6:PlayEffectModule(u1.EffectModule, "Emit", v12.CFrame, p11);
        end),
        [#v13 + 1] = v8:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 99
        ...
        [#v13 + 1] = v8:GetMarkerReachedSignal("DBreset"):Connect(function() -- Line: 109
            -- upvalues: u10 (ref)
            u10 = true;
        end)
    };
    ...
    task.delay(u7.MaxDuration or u1.MaxDuration, function() -- Line: 111
        -- upvalues: u10 (ref)
        u10 = true;
    end);
