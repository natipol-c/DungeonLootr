--[[
  ...
  Method:   decompile
  Name:     Thorn Recoil
  Path:     game.ReplicatedStorage.Classes.Witch Gunner.Skills.Thorn Recoil
...
function u1.Activate(u11, p12) -- Line: 100
    ...
    if not v13 then
        warn("[Thorn Recoil] Animation not found");
    ...
    v13:Play(0, 1, 1);
    local u15 = v13:GetMarkerReachedSignal("hit"):Connect(function(p14) -- Line: 131
    ...
    local u19 = v13:GetMarkerReachedSignal("dash"):Connect(function(p16) -- Line: 141
        ...
        BodyVelocity.Velocity = v18 * u1.DashSpeed;
    ...
    v13.Stopped:Once(function() -- Line: 173
        -- upvalues: u20 (ref), u11 (copy), u15 (ref), u19 (ref), u21 (copy)
        if not u20 then
            u20 = true;
            u11.Is_Using_Skill = false;
            u11.Is_Attacking = false;
    ...
    task.delay(u1.IFrameDuration, function() -- Line: 181
        -- upvalues: u11 (copy)
        if u11.Player then
    ...
    task.delay(u1.MaxDuration, function() -- Line: 191
        -- upvalues: u20 (ref), u11 (copy), u15 (ref), u19 (ref), u21 (copy)
        if not u20 then
            u20 = true;
            u11.Is_Using_Skill = false;
