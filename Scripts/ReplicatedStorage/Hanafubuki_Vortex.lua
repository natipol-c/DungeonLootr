--[[
  ...
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Zero.Hanafubuki_Vortex
...
local u1 = {
    AnimationName = "Ability_4_Hold",
    EffectModule = "Hanafubuki_Vortex",
    MaxDuration = 5,
    TickDamage = 1.2,
    TickInterval = 0.35,
    FinalDamage = 3.5,
    ...
    FinalVolume = 1,
    SwingSFXFolder = "Ninja"
};

local function freezeHRP(p2) -- Line: 85
...
local function unfreezeHRP(p4) -- Line: 89
...
function u1._PerformHit(p6, p7, p8) -- Line: 95
    -- upvalues: u1 (copy)
...
function u1.Activate(u11, u12) -- Line: 109
    ...
    local u15 = u12.SwingSoundFolder or u1.SwingSFXFolder;
    ...
    local v22 = v14:GetMarkerReachedSignal("dash"):Connect(function() -- Line: 136
    ...
    local v25 = v14:GetMarkerReachedSignal("VFX"):Connect(function(p23) -- Line: 150
    ...
    local v29 = v14:GetMarkerReachedSignal("Start"):Connect(function() -- Line: 159
    ...
    local v32 = v14:GetMarkerReachedSignal("End"):Connect(function() -- Line: 183
    ...
    local v34 = v14:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 190
    ...
    local v35 = v14:GetMarkerReachedSignal("DBreset"):Connect(function() -- Line: 202
        -- upvalues: u17 (ref)
        u17 = true;
    end);
    v14.Stopped:Once(function() -- Line: 205
        -- upvalues: u17 (ref)
        u17 = true;
    end);
    task.delay(u12.MaxDuration or u1.MaxDuration, function() -- Line: 206
        -- upvalues: u17 (ref)
        u17 = true;
    end);
    ...
    u18 = false;
    local v36 = u11.Character and u11.Character:FindFirstChild("HumanoidRootPart");
