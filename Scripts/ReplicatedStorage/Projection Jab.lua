--[[
  ...
  Method:   decompile
  Name:     Projection Jab
  Path:     game.ReplicatedStorage.Classes.Framebreaker.Skills.Projection Jab
...
function u1.Activate(u20, p21) -- Line: 136
    ...
    if not v22 then
        warn("[Projection Jab] Animation not found");
    ...
    v22:Play(0, 1, 1);
    local u26 = v22:GetMarkerReachedSignal("hit"):Connect(function(u23) -- Line: 163
        ...
        task.delay(0.1, function() -- Line: 172
            -- upvalues: u20 (ref), u23 (copy), u1 (ref)
            u20:PlayCombatSound(u20.ClassData.SwingSoundFolder or "Flame_Swing", nil, u20.ClassData.SwingVolume or 0.5);
            local v25;
    ...
    v22.Stopped:Once(function() -- Line: 195
