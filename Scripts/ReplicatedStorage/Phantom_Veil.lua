--[[
  ...
  Method:   decompile
  Name:     Phantom_Veil
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Dark Rider.Phantom_Veil
...
local u1 = {
    ...
    MaxDuration = 3,
    HitboxSize = Vector3.new(12, 14, 24),
    HitboxRange = 26
};
...
function u1.Activate(u6, u7) -- Line: 48
    ...
    if not v8 then
        warn("[Boss Phantom_Veil] Animation not found:", u1.AnimationName);
    ...
    local v13 = v8:GetMarkerReachedSignal("dash"):Connect(function(p10) -- Line: 68
        ...
        BodyVelocity.Velocity = v12 * (u7.DashSpeed or 85);
