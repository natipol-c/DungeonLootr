--[[
  ...
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Founder.Pillar_of_Heaven
...
function u1._PerformHit(p2, p3) -- Line: 25
    -- upvalues: u1 (copy)
...
function u1.Activate(u6, u7) -- Line: 35
    -- upvalues: u1 (copy)
    local u8 = u6.Animations[u1.AnimationName];

    if not u8 then
        warn("[Boss Pillar_of_Heaven] Animation not found:", u1.AnimationName);
    ...
    local function bindVFX(p12) -- Line: 52
        -- upvalues: u11 (copy), u8 (copy), u6 (copy), u1 (ref)
        u11[#u11 + 1] = u8:GetMarkerReachedSignal(p12):Connect(function(p13) -- Line: 53
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX"):Connect(function(p15) -- Line: 53
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX_2"):Connect(function(p17) -- Line: 53
        -- upvalues: u6 (copy), u1 (ref)
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX_3"):Connect(function(p19) -- Line: 53
        -- upvalues: u6 (copy), u1 (ref)
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX_4"):Connect(function(p21) -- Line: 53
        -- upvalues: u6 (copy), u1 (ref)
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 62
    ...
    u8.Stopped:Once(function() -- Line: 71
        -- upvalues: u10 (ref)
        u10 = true;
    end);
    task.delay(u7.MaxDuration or u1.MaxDuration, function() -- Line: 72
        -- upvalues: u10 (ref)
        u10 = true;
    end);
