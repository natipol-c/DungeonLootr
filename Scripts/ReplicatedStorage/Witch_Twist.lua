--[[
  ...
  Method:   decompile
  Name:     Witch_Twist
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Witch Gunner.Witch_Twist
...
function u1.Activate(u6, u7) -- Line: 49
    ...
    if not v8 then
        warn("[Boss Witch_Twist] Animation not found:", u1.AnimationName);
    ...
    BodyVelocity.Velocity = Character.CFrame.LookVector * (u7.DashSpeed or 55);
    BodyVelocity.Parent = Character;
    Debris:AddItem(BodyVelocity, u7.DashDuration or 0.2);
    local v11 = v8:GetMarkerReachedSignal("hit"):Connect(function(p10) -- Line: 77
    ...
    v8.Stopped:Once(function() -- Line: 86
        -- upvalues: u9 (ref)
        u9 = true;
    end);
