--[[
  ...
  Method:   decompile
  Name:     Crimson Rush
  Path:     game.ReplicatedStorage.Classes.Dreadlord.Skills.Crimson Rush
...
function u2.Activate(u20, p21) -- Line: 146
    ...
    if not v22 then
        warn("[Crimson Rush] Animation not found");
    ...
    local u31 = nil;
    u31 = v22:GetMarkerReachedSignal("DBreset"):Connect(function() -- Line: 235
    ...
    task.delay(u2.MaxDuration, function() -- Line: 248
