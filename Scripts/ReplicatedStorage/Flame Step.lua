--[[
  ...
  Method:   decompile
  Name:     Flame Step
  Path:     game.ReplicatedStorage.Classes.Hollow.Skills.Flame Step
...
local u1 = {
    ...
    EffectModule = "Flame_Step",
    Skill_SFX = nil,
    HitboxSize = Vector3.new(28, 14, 32),
    HitboxRange = 26,
    DodgeDuration = 1,
    DashSpeed = 70,
    DashDuration = 0.15,
...
function u1.CanActivate(p9) -- Line: 106
...
function u1.Activate(u10, p11) -- Line: 114
    ...
    task.delay(u1.DodgeDuration, function() -- Line: 138
    ...
    local function cleanup() -- Line: 173
    ...
    u15[#u15 + 1] = v12:GetMarkerReachedSignal("VFX"):Connect(function(p17) -- Line: 185
    ...
    u15[#u15 + 1] = v12:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 195
        ...
        u10:PlayCombatSound(u1.Skill_SFX or u10.ClassData.SwingSoundFolder or "Naoya_Punches", nil, u10.ClassData.SwingVolume or 1);
        u1._PerformHit(u10);
    end);
