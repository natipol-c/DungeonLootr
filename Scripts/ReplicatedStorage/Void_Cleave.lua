--[[
  ...
  Method:   decompile
  Name:     Void_Cleave
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Azure Devil.Void_Cleave
...
function u1.Activate(u6, u7) -- Line: 51
    ...
    if not v8 then
        warn("[Boss Void_Cleave] Animation not found:", u1.AnimationName);
    ...
    local v12 = v8:GetMarkerReachedSignal("hit"):Connect(function(p10) -- Line: 70
        ...
        if v11 then
            SharedUtils.PlaySoundAt(v11, "Judgement_Cut", 0.9);
        end;
