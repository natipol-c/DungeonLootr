--[[
  Type:     ModuleScript
  Method:   decompile
  Name:     Howling Barrage
  Path:     game.ReplicatedStorage.Classes.Coyote.Skills.Howling Barrage
...
local u1 = {
    ...
    EffectModule = "Cero_Phantom",
    HitboxSize = Vector3.new(20, 12, 45),
    HitboxRange = 45,
    MaxDuration = 3
};
...
function u1.Activate(u10, p11) -- Line: 108
    ...
    if not v12 then
        warn("[Howling Barrage] Animation not found");
    ...
    u10:PlayEffectModule(u1.EffectModule, "Begin", CFrame);
    v12:Play(0, 1, 1);
    local u13 = {};
    ...
    local function cleanup() -- Line: 155
        -- upvalues: u13 (copy), u14 (ref), u10 (copy)
        for _, v in u13 do
            v:Disconnect();
        end;
    ...
    local u15 = 0;
    u13[#u13 + 1] = v12:GetMarkerReachedSignal("Hit"):Connect(function() -- Line: 162
        -- upvalues: u15 (ref), u10 (copy), u1 (ref), CFrame (copy)
        u15 = u15 + 1;
        u10:PlayEffectModule(u1.EffectModule, "Shot", CFrame, u15);
        u1._PerformHit(u10);
        u10:ShakeCamera("SkillLight");
    end);
    local u16 = 0;
    u13[#u13 + 1] = v12:GetMarkerReachedSignal("TP"):Connect(function() -- Line: 171
        -- upvalues: u16 (ref), u10 (copy), u1 (ref), CFrame (copy)
        u16 = u16 + 1;
        u10:PlayEffectModule(u1.EffectModule, "Flashstep", CFrame, u16);
    end);
