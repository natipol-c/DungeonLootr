--[[
  ...
  Method:   decompile
  Name:     Witch Twist
  Path:     game.ReplicatedStorage.Classes.Witch Gunner.Skills.Witch Twist
...
function u1.Activate(u11, p12) -- Line: 104
    ...
    if not v13 then
        warn("[Witch Twist] Animation not found");
    ...
    if Humanoid and Humanoid.MoveDirection.Magnitude > 0 then
        ...
        v14 = Character.CFrame.LookVector;
    end;
    ...
    v13:Play(0, 1, 1.8);
    local u16 = v13:GetMarkerReachedSignal("hit"):Connect(function(p15) -- Line: 151
    ...
    local function releaseState() -- Line: 161
    ...
    v13.Stopped:Once(function() -- Line: 172
    ...
    task.delay(u1.IFrameDuration, function() -- Line: 179
        -- upvalues: u11 (copy)
        if u11.Player then
    ...
    task.delay(u1.MaxDuration, function() -- Line: 189
        -- upvalues: u17 (ref), u11 (copy), u16 (ref), u18 (copy)
        if not u17 then
            u17 = true;
            u11.Is_Using_Skill = false;
