--[[
  ...
  Method:   decompile
  Name:     GiveScope
  Path:     game.ReplicatedStorage.CmdrClient.Types.GiveScope
...
local u1 = { "player", "server", "global" };

return function(p2) -- Line: 6
    -- upvalues: u1 (copy)
    p2:RegisterType("giveScope", {
        DisplayName = "Scope",
        ...
        Validate = function(p4) -- Line: 14, Name: Validate
            ...
            return false, `"{p4}" is not a valid scope. Options: player, server, global`;
        end,
