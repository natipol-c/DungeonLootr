--[[
  ...
  Method:   decompile
  Name:     Sky_Crash
  Path:     game.ReplicatedStorage.GameInfo.Boss_Abilities.Awakened Devil EX.Sky_Crash
...
function u1.Activate(u6, u7) -- Line: 53
    ...
    if not u8 then
        warn("[Boss Sky_Crash] Animation not found:", u1.AnimationName);
    ...
    BodyVelocity.Velocity = v9.CFrame.LookVector * (u7.DashSpeed or 70);
    BodyVelocity.Parent = v9;
    Debris:AddItem(BodyVelocity, u7.DashDuration or 0.15);
    local u11 = {};

    local function bindVFX(p12) -- Line: 81
        -- upvalues: u11 (copy), u8 (copy), u6 (copy), u1 (ref)
        u11[#u11 + 1] = u8:GetMarkerReachedSignal(p12):Connect(function(p13) -- Line: 82
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX"):Connect(function(p15) -- Line: 82
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("VFX_2"):Connect(function(p17) -- Line: 82
        -- upvalues: u6 (copy), u1 (ref)
    ...
    u11[#u11 + 1] = u8:GetMarkerReachedSignal("hit"):Connect(function() -- Line: 92
        -- upvalues: u6 (copy), SharedUtils (ref), u1 (ref), u7 (copy)
        local v19 = u6.Character and u6.Character:FindFirstChild("HumanoidRootPart");

        if v19 then
            SharedUtils.PlaySoundAt(v19, "power_spin_04", 1);
        end;

        u1._PerformHit(u6, u7);
    end);
    u8.Stopped:Once(function() -- Line: 98
        -- upvalues: u10 (ref)
        u10 = true;
    end);
    task.delay(u7.MaxDuration or u1.MaxDuration, function() -- Line: 99
        -- upvalues: u10 (ref)
        u10 = true;
    end);
